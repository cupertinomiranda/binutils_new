...
const unsigned arc_num_flag_operands =
  sizeof (arc_flag_operands) / sizeof (*arc_flag_operands);
...
const unsigned arc_num_operands =
  sizeof (arc_operands) / sizeof (*arc_operands);
...
const unsigned arc_num_opcodes =
  sizeof (arc_opcodes) / sizeof (*arc_opcodes);
...
const unsigned arc_num_flag_special =
  sizeof (arc_flag_special_cases) / sizeof (*arc_flag_special_cases);
...
const unsigned arc_num_equiv_tab =
  sizeof (arc_reloc_equiv) / sizeof (*arc_reloc_equiv);
...
const unsigned arc_num_aux_regs =
  sizeof (arc_aux_regs) / sizeof (*arc_aux_regs);
